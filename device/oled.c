...
const unsigned char OLED_16X8GB2312[][32] =
{
	...
	0x10,0x94,0x53,0x32,0x1E,0x32,0x52,0x10,0x00,0x7E,0x42,0x42,0x42,0x7E,0x00,0x00,//智6
	0x00,0x00,0x00,0xFF,0x49,0x49,0x49,0x49,0x49,0x49,0x49,0xFF,0x00,0x00,0x00,0x00,
	0x08,0xCC,0x4A,0x49,0x48,0x4A,0xCC,0x18,0x00,0x7F,0x88,0x88,0x84,0x82,0xE0,0x00,//能7
	0x00,0xFF,0x12,0x12,0x52,0x92,0x7F,0x00,0x00,0x7E,0x88,0x88,0x84,0x82,0xE0,0x00,
	0x00,0x08,0x88,0x48,0x28,0x18,0x0F,0xE8,0x08,0x08,0x08,0x08,0x08,0x08,0x00,0x00,//车8
	0x08,0x08,0x09,0x09,0x09,0x09,0x09,0xFF,0x09,0x09,0x09,0x09,0x09,0x08,0x08,0x00,
	0x00,0xFE,0x02,0x22,0xDA,0x06,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,//队9
    ...
    0x90,0x52,0x34,0x10,0xFF,0x10,0x34,0x52,0x80,0x70,0x8F,0x08,0x08,0xF8,0x08,0x00,//数11
    0x82,0x9A,0x56,0x63,0x22,0x52,0x8E,0x00,0x80,0x40,0x33,0x0C,0x33,0x40,0x80,0x00,
	0x04,0x74,0xD4,0x54,0xFF,0x54,0xD4,0x74,0x14,0x08,0x77,0x84,0x44,0x3C,0x04,0x00,//整12
	0x82,0x89,0x88,0xE8,0x8B,0x88,0x88,0xF9,0xA8,0xAA,0xA9,0xA8,0xA9,0x8A,0x82,0x00,
	0x10,0x0C,0x44,0x44,0x44,0x44,0x45,0xC6,0x44,0x44,0x44,0x44,0x44,0x14,0x0C,0x00,//定13
	0x80,0x40,0x20,0x1E,0x20,0x40,0x40,0x7F,0x44,0x44,0x44,0x44,0x44,0x40,0x40,0x00,
    0x04,0x84,0xE4,0x5C,0x44,0xC4,0x00,0xF2,0x92,0x92,0xFE,0x92,0x92,0xF2,0x02,0x00,//硬14
    0x02,0x01,0x7F,0x10,0x10,0x3F,0x80,0x8F,0x54,0x24,0x5F,0x44,0x84,0x87,0x80,0x00,
    0x00,0x80,0x60,0xF8,0x07,0x80,0x60,0x1C,0x10,0x10,0xFF,0x10,0x10,0x10,0x00,0x00,//件15
    0x01,0x00,0x00,0xFF,0x00,0x02,0x02,0x02,0x02,0x02,0xFF,0x02,0x02,0x02,0x02,0x00,
    0x10,0x60,0x02,0x8C,0x00,0xFE,0x02,0xF2,0x02,0xFE,0x00,0xF8,0x00,0xFF,0x00,0x00,//测16
    0x04,0x04,0x7E,0x01,0x80,0x47,0x30,0x0F,0x10,0x27,0x00,0x47,0x80,0x7F,0x00,0x00,
	0x40,0x40,0x42,0xCC,0x00,0x90,0x90,0x90,0x90,0x90,0xFF,0x10,0x11,0x16,0x10,0x00,//试17
	0x00,0x00,0x00,0x3F,0x10,0x28,0x60,0x3F,0x10,0x10,0x01,0x0E,0x30,0x40,0xF0,0x00,
0x00,0xFE,0x02,0x42,0x22,0x32,0x5E,0x92,0x52,0x32,0x12,0x02,0x02,0xFE,0x00,0x00,//图18
0x00,0xFF,0x42,0x42,0x42,0x51,0x55,0x64,0x69,0x41,0x42,0x42,0x42,0xFF,0x00,0x00,
0x00,0x80,0x60,0xF8,0x17,0x08,0x7C,0x4B,0xCA,0x6A,0x5A,0x4E,0x48,0x78,0x00,0x00,//像19
0x01,0x00,0x00,0xFF,0x00,0x4A,0x4A,0x25,0x52,0x89,0x7E,0x04,0x1A,0x21,0x40,0x00,
0x00,0x00,0x00,0xFE,0x92,0x92,0x92,0x92,0x92,0x92,0x92,0xFE,0x00,0x00,0x00,0x00,//显20
0x40,0x42,0x44,0x58,0x40,0x7F,0x40,0x40,0x40,0x7F,0x40,0x50,0x48,0x46,0x40,0x00,
0x40,0x40,0x42,0x42,0x42,0x42,0x42,0xC2,0x42,0x42,0x42,0x42,0x42,0x40,0x40,0x00,//示21
0x20,0x10,0x08,0x06,0x00,0x40,0x80,0x7F,0x00,0x00,0x00,0x02,0x04,0x08,0x30,0x00,
	0x00,0x04,0x24,0x24,0x24,0x24,0x24,0xFF,0x24,0x24,0x24,0x24,0x24,0x04,0x00,0x00,//表22
	0x21,0x21,0x11,0x09,0xFD,0x83,0x41,0x23,0x05,0x09,0x11,0x29,0x25,0x41,0x41,0x00,
    0x20,0x30,0xAC,0x63,0x20,0x18,0x08,0x48,0x48,0x48,0x7F,0x48,0x48,0x48,0x08,0x00,//结23
    0x22,0x67,0x22,0x12,0x12,0x12,0x00,0xFE,0x42,0x42,0x42,0x42,0x42,0xFE,0x00,0x00,
    0x04,0x04,0xE4,0x24,0x24,0x24,0x24,0xFF,0x24,0x24,0x24,0x24,0xE4,0x04,0x04,0x00,//束24
    0x40,0x40,0x27,0x22,0x12,0x0A,0x06,0xFF,0x06,0x0A,0x12,0x22,0x27,0x40,0x40,0x00,
	0x00,0x70,0x88,0x08,0x08,0x08,0x38,0x00,0x08,0xF8,0x08,0x08,0x08,0x10,0xE0,0x00,//SD25
	0x00,0x38,0x20,0x21,0x21,0x22,0x1C,0x00,0x20,0x3F,0x20,0x20,0x20,0x10,0x0F,0x00,
    0x40,0x40,0x40,0x40,0x40,0x40,0xFF,0x44,0x44,0x44,0x44,0x44,0x44,0x40,0x40,0x00,//卡26
...
static OCB ocb_table[OLED_NUM];//OLED_NUM==4  灯的数量为4



GPIO_InitTypeDef gl_gpio_oled_sclk = {OLED_SCLK_PORT, OLED_SCLK_PIN, IRQC_DIS, DIR_OUTPUT, OUTPUT_L};//PTE,GPIO_Pin12，中断禁用，低电平-OUTPUT_L
GPIO_InitTypeDef gl_gpio_oled_sdin = {OLED_SDIN_PORT, OLED_SDIN_PIN, IRQC_DIS, DIR_OUTPUT, OUTPUT_L};//PTE,GPIO_Pin12，中断禁用，低电平-OUTPUT_L
GPIO_InitTypeDef gl_gpio_oled_dc   = {OLED_DC_PORT,   OLED_DC_PIN, IRQC_DIS, DIR_OUTPUT, OUTPUT_L};//PTE,GPIO_Pin12，中断禁用，低电平-OUTPUT_L
GPIO_InitTypeDef gl_gpio_oled_rst  = {OLED_RST_PORT,  OLED_RST_PIN, IRQC_DIS, DIR_OUTPUT, OUTPUT_L};//PTE,GPIO_Pin12，中断禁用，低电平-OUTPUT_L

#define   INDEX_OLED(oled_no)    ((uint8)(oled_no))//将oled_no变为unit8型
#define   get_lgcb(oled_no)      (&(ocb_table[INDEX_OLED(oled_no)]))//取全局变量ocb_table中第oled_no个元素的地址

#define   OLED_NO_GET(oledchar)    (oledchar & 0x0000ffff)//逻辑与操作，只保留0-15位的值
#define   OLED_PORT_GET(oledchar)  (PORT_NO_GET(oledchar >> 16))//右移16位，只有0-15位有值
#define   OLED_PIN_GET(oledchar)   (PIN_NO_GET(oledchar >> 16))//右移16位，只有0-15位有值

#define   initSCLK_DDR()   (LPLD_GPIO_Init(gl_gpio_oled_sclk))//按照定义好的结构体初始化 PTE12 
#define   initSDIN_DDR()   (LPLD_GPIO_Init(gl_gpio_oled_sdin))//按照定义好的结构体初始化 PTE11
#define   initDC_DDR()     (LPLD_GPIO_Init(gl_gpio_oled_dc))//按照定义好的结构体初始化  PTE8
#define   initRST_DDR()    (LPLD_GPIO_Init(gl_gpio_oled_rst))//按照定义好的结构体初始化 PTE9

#define GPIO_SETHIGH(PORT_H,PIN_H) ((PORT_H)->PSOR = (PIN_H))//PORT_H模块的PSOR(修改输出端口PDOR的值)0：PDORn 的相应位不变 1：PDORn 的相应位被设置为逻辑 1
#define GPIO_SETLOW(PORT_L,PIN_L) ((PORT_L)->PCOR = (PIN_L))//PORT_H模块的PSOR(修改输出端口PCOR的值)0：PDORn 的相应位不变 1：PDORn 的相应位被设置为逻辑 0

//按照x的值将OLED_X_PORT模块的OLED_X_PIN引脚置高或置低
#define   OLED_SCLK(x)       ((x)?(GPIO_SETHIGH(OLED_SCLK_PORT,OLED_SCLK_PIN)):(GPIO_SETLOW(OLED_SCLK_PORT,OLED_SCLK_PIN)))//gpio_set(OLED_SCLK_PORT,OLED_SCLK_PIN,(x)) 
#define   OLED_SDIN(x)       ((x)?(GPIO_SETHIGH(OLED_SDIN_PORT,OLED_SDIN_PIN)):(GPIO_SETLOW(OLED_SDIN_PORT,OLED_SDIN_PIN)))//gpio_set(OLED_SDIN_PORT,OLED_SDIN_PIN,(x)) 
#define   OLED_DC(x)         ((x)?(GPIO_SETHIGH(OLED_DC_PORT,OLED_DC_PIN)):(GPIO_SETLOW(OLED_DC_PORT,OLED_DC_PIN)))//gpio_set(OLED_DC_PORT,OLED_DC_PIN,(x))  
#define   OLED_RST(x)        ((x)?(GPIO_SETHIGH(OLED_RST_PORT,OLED_RST_PIN)):(GPIO_SETLOW(OLED_RST_PORT,OLED_RST_PIN)))//gpio_set(OLED_RST_PORT,OLED_RST_PIN,(x)) 
...
void oled_pin_init(void)
{
    ...
    for (p_lgcb = ocb_table, i = 0; i < OLED_NUM; p_lgcb++, i++)//全局变量ocb,把ocb数组中的openflag全部初始化为0 charrorflag全部初始化为1
    {
        p_lgcb->openflag  = false;//#define   false    0
        p_lgcb->charrorflag = E_SYS;//#define   E_SYS   1
    }
...
// #define   initRST_DDR()    (LPLD_GPIO_Init(gl_gpio_oled_rst))
    ...
    initSCLK_DDR();//GPIO初始化，按照定义好的结构体初始化 PTE12
    OLED_SCLK(LOW);//前面宏定义的函数，括号中为HIGH即为将OLED_SCLK_PORT（PTE）->GPIO_Pin12置1，LOW为置0
    
    initSDIN_DDR();//GPIO初始化，按照定义好的结构体初始化 PTE11
    OLED_SDIN(LOW);//将OLED_SDIN_PORT（PTE）->GPIO_Pin11置1，LOW为置0
    
    initDC_DDR();//GPIO初始化，按照定义好的结构体初始化 PTE8
    OLED_DC(LOW);//将OLED_DC_PORT（PTE）->GPIO_Pin8置1，LOW为置0
    
    initRST_DDR();//GPIO初始化，按照定义好的结构体初始化 PTE9
    OLED_RST(LOW);//将OLED_RST_PORT（PTE）->GPIO_Pin9置1，LOW为置0
}
 ...
 * 概要   @brief   写一个字节数据
 *
 * 参数   @param   uint8 uc_data
 */
//低位在一竖的顶部 高位在底部
void oled_write_data(uint8 uc_data)
{
    uint8 i = 8;//DC = 1,write data

    OLED_DC(HIGH);//（PTE）->GPIO_Pin8 置0          gpio_set(OLED_PORT_GET(OLED_DC),OLED_PIN_GET(OLED_DC),0);
    OLED_SCLK(LOW);//（PTE）->GPIO_Pin12 置0         gpio_set(OLED_PORT_GET(OLED_SCLK),OLED_PIN_GET(OLED_SCLK),0);

    while (i--)//i初始值为8，即循环八次，每次uc_data左移1位，即为历遍uc_data每一位的值（从7-0）
    {
        if (uc_data & 0x80)//0x80为1000 0000，条件成立 PTE->GPIO_Pin11置1
        {
        	OLED_SDIN(HIGH);//条件成立 PTE->GPIO_Pin11置1  gpio_set(OLED_PORT_GET(OLED_SDIN),OLED_PIN_GET(OLED_SDIN),1);
        }
        else
        {
        	OLED_SDIN(LOW);//不然 PTE->GPIO_Pin11置0  gpio_set(OLED_PORT_GET(OLED_SDIN),OLED_PIN_GET(OLED_SDIN),0);
        }
        /* 普通I/O口模拟时钟信号 */

        OLED_SCLK(HIGH);//（PTE）->GPIO_Pin12 置1  gpio_set(OLED_PORT_GET(OLED_SCLK),OLED_PIN_GET(OLED_SCLK),1);
        
        asm("nop");
        
        OLED_SCLK(LOW);//（PTE）->GPIO_Pin12 置0  gpio_set(OLED_PORT_GET(OLED_SCLK),OLED_PIN_GET(OLED_SCLK),0);

        uc_data <<= 1;//uc_data左移1位
    }
    return;
}
...
{
    uint8 i = 8;//DC = 0,write command
    
    OLED_DC(LOW);//（PTE）->GPIO_Pin8 置0          gpio_set(OLED_PORT_GET(OLED_DC),OLED_PIN_GET(OLED_DC),0);
    OLED_SCLK(LOW);//（PTE）->GPIO_Pin12 置0         gpio_set(OLED_PORT_GET(OLED_SCLK),OLED_PIN_GET(OLED_SCLK),0);

    while (i--)//i初始值为8，即循环八次，每次uc_cmd左移1位，即为历遍uc_cmd每一位的值（从7-0）
    {
        if (uc_cmd & 0x80)//0x80为1000 0000    即第八位为1
        {
            OLED_SDIN(HIGH);//（PTE）->GPIO_Pin11 置1      gpio_set(OLED_PORT_GET(OLED_SDIN),OLED_PIN_GET(OLED_SDIN),1);
        }
        else
        {
            OLED_SDIN(LOW);//（PTE）->GPIO_Pin11 置0       gpio_set(OLED_PORT_GET(OLED_SDIN),OLED_PIN_GET(OLED_SDIN),0);
        }
        /* 普通I/O口模拟时钟信号 */
...
{
    oled_write_command(0xb0 + uc_posy);//0xb0为 1011 0000 
    oled_write_command(((uc_posx & 0xf0) >> 4) | 0x10);//uc_posx & 0xf0即保留4-7位，右移4位将4-7位变成0-3位，后|0x10，将第四位置1
    oled_write_command((uc_posx & 0x0f) | 0x00);//uc_posx & 0x0f 保留0-3位
}
...
void oled_fill(char uc_data)
{
    ...
    for(uc_page = 0; uc_page < 8; uc_page++)
    {
        ...
        {
            oled_write_data(uc_data);//写一个字节数据
        }
    }
}
 ...
 *	@ return  none
 */
void SetDisplayOnOff(uint8 uc_data)//SetDisplayOnOff 打开或关闭
{
 ...
 *	@ return  none
 */
void oled_display_6x8char(uint8 uc_posx, uint8 uc_posy, char uc_data)//显示6x8字体库字符
{
    uint8 i, uc_dataTmp;

    uc_dataTmp = uc_data;
    if(uc_posx > 122)//uint8 uc_posx  显示的横坐标0~122,超过重新设置为1
    {
        uc_posx = 0;
        uc_posy ++;
    }

    oled_set_pos(uc_posx, uc_posy);//设置坐标

    for(i = 0; i < 6; i++)
    {
        oled_write_data(F6x8[uc_dataTmp][i]);//写出一个字节数据，即将一个字节按高到低输出8位
    }
}

void oled_display_16x8char(uint8 uc_posx, uint8 uc_posy, char uc_data)//显示16x8字体库字体
{
	uint8 i, uc_dataTmp;
    ...
    for(i = 0; i < 8; i++)//先打印页范围内的数据
    {
        oled_write_data(OLED_ASCII16X8[uc_dataTmp][i]);//依次写出一个字节数据
    }

	oled_set_pos(uc_posx, uc_posy+1);//设置坐标，页数加一

    for(i = 8; i < 16; i++)//再打印可显示横坐标的数据
    {
        oled_write_data(OLED_ASCII16X8[uc_dataTmp][i]);//依次写出一个字节数据
    }
}

void oled_display_16x8char_hl(uint8 uc_posx, uint8 uc_posy, char uc_data)//显示16x8字体库字体
{
    uint8 i, uc_dataTmp;
 ...
 *	@ return  none
 */
void oled_display_6x8str(uint8 uc_posx, uint8 uc_posy, char uc_dataStr[])//显示6x8字符串
{
    uint8 i, j, uc_dataTmp;

    //保证图像处理优先级
//    if ((g_Camera_Is_Image_Ok == 1))
//    {
//        return;
//    }
 ...
 * 显示16x8的字符串
 *****************/
void oled_display_16x8str(uint8 uc_posx, uint8 uc_posy, char uc_dataStr[])//显示16x8的字符串
{
    uint8 i, j, uc_dataTmp;
...
void oled_display_16x8str_hl(uint8 uc_posx, uint8 uc_posy, char uc_dataStr[])
{
    ...
    for (j = 0; uc_dataStr[j] != '\0'; j++)
    {
		...
		oled_set_pos(uc_posx,uc_posy+1);//页面加一
 ...
 *	@ return  none
 */
void oled_print_char(uint8 uc_posx, uint8 uc_posy, int8 c_data)//将一个(typedef signed char int8)Char型数转换成3位数进行显示
{//在6x8模式下
    ...
    if(c_data < 0)
    {
        ...
        us_data = (uint16)(-c_data);//将小于0的数据变为正数
    }
    else
    {
    	oled_display_6x8char(uc_posx, uc_posy, '+');
...
void oled_print_16x8char(uint8 uc_posx, uint8 uc_posy, int8 c_data)//将一个(typedef signed char int8)Char型数转换成3位数进行显示
{//在16x8模式下
    uint16 i, j, k, us_data;
 ...
 *	@ return  none
 */
void oled_print_short(uint8 uc_posx, uint8 uc_posy, int16 s_data)//typedef short int int16;
{//将短整形数变成五位数显示(6x8字体库下)
    uint16 i, j, k, l, m, us_data;

    //保证图像处理优先级
//    if ((g_Camera_Is_Image_Ok == 1))// && (g_carInfo.u8SlaveComFlag == 0))
//    {
//        return;
//    }
...
void oled_print_16x8short(uint8 uc_posx, uint8 uc_posy, int16 s_data)//typedef short int int16;
{//将短整形数变成五位数显示(16x8字体库下)
    uint16 i, j, k, l, m, us_data;
...
//{
//    oled_print_mirror_image(g_corrected_image,64,128);
//}
...
void  oled_init(void)
{
    ...
    SetDisplayOnOff(0x00);     // Display Off (0x00/0x01) 把Display功能关闭

    SetDisplayClock(0x80);     // Set Clock as 100 Frames/Sec  时钟设置为100秒
 ...
 *	@ return  none
 */
void  oled_gap(void)//在(63,0),(63,2),(63,4),(63,6)四个坐标处分别输出6X8的字体库'-'
{
 ...
 *	@ return  none
 */
void  oled_twink(void)//提示oled在工作
{
	static int8 s_num = 0;
 ...
 *	@ return  none
 */
void  oled_clear(uint8 start_x, uint8 page, uint8 clear_size)//确定范围清屏
{
	uint8 loop_i = 0;
...
void  oled_one_group(uint8 my_x, uint8 my_y, uint16 my_data)//short int	uint16;
{//将一行分为4个位置，x范围0~3，y范围为uc_posy = (uint8)2 * my_y;
    uint8  i = 0;
    uint8  j = 0;
    uint8  k = 0;
    uint16 data = my_data;
...
void oled_display_6x8char_hl(uint8 uc_posx, uint8 uc_posy, char uc_data)//在指定位置输出一个6x8字符
{
    uint8 i, uc_dataTmp;
    ...
    for(i = 0; i < 6; i++)
    {
        oled_write_data((~F6x8[uc_dataTmp][i]));//数据低位在一竖的顶部 高位在底部
    }
}
void oled_display_6x8str_hl(uint8 uc_posx, uint8 uc_posy, char uc_dataStr[])//输出多个数据构成的字符串
{
    uint8 i, j, uc_dataTmp;
...
void oled_print_char_hl(uint8 uc_posx, uint8 uc_posy, int8 c_data)//将一个数据输出成6x8字库下的三位数
{
    uint16 i, j, k, us_data;
...
void oled_print_short_hl(uint8 uc_posx, uint8 uc_posy, int16 s_data, int8 bits_num)//将一个数据输出成6x8字库下bits_num位数
{
    uint16 i, j, k, l, m, us_data;
    ...
    switch(bits_num)//bits_num决定输出为几位数
    {
...
void oled_display_chinese(uint8 uc_posx, uint8 uc_posy, uint8 Chinese_str_num, enum OLED_LIGHT_MODE mode)
{
	...
	{
		//华中科技大学
		case HUAKE_UNIVERSITY:
			start_char = 0;
			end_char = 5;
			break;
		//智能车队
		case SMART_MOTORCADE:
			start_char = 6;
			end_char = 9;
			break;
		//开机测试
